...
export default async function Home({ params }) {
  ...
  const res = await fetch(`http://${host}/api/getPodcast/${params.podcast}`, {
    cache: 'no-store',
  })
                    ...
                    <div className=" w-full lg:w-3/5 flex flex-col justify-center items-center">
                      ...
                      <ul className="flex flex-col w-full mb-4">
                        ...
                        <li className="text-sm text-gray-800">
                          &#x2022;{' '}
                          {'Date : ' +
                            new Date(episode.createdAt * 1000).toDateString()}
                        </li>
                      </ul>
                    </div>
                  </div>
